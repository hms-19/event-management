                            ...
                            <div class="basic-form">
                                <form method="POST" action="{{ route('announcements.update',['announcement' => $announcement]) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="title" name="title" value="{{ $announcement->title }}" required autofocus  class="form-control input-default " placeholder="Enter Title">
                                    </div>
                                    @error('title')
                                    ...
                                    <textarea id="content" name="content" placeholder="Write Content Here..." class="my-3">{{ $announcement->content }}</textarea>
                                    @error('content')
                                        <p class="text-danger mb-2">
                                            {{ $message }}
                                        </p>
